   ...
   */    var objectToString = Object.prototype.toString;
    ...
    Context.prototype.lookup = function lookup(name) {
        ...
        if (cache.hasOwnProperty(name)) value = cache[name]; else {
            var intermediateValue, names, index, context = this, lookupHit = false;
            while (context) {
                if (name.indexOf(".") > 0) {
    ...
    Writer.prototype.getConfigTags = function getConfigTags(config) {
        if (isArray(config)) return config; else if (config && typeof config === "object") return config.tags; else return;
    };
    Writer.prototype.getConfigEscape = function getConfigEscape(config) {
        if (config && typeof config === "object" && !isArray(config)) return config.escape; else return;
    };
    var mustache = {
        name: "mustache.js",
        version: "4.2.0",
