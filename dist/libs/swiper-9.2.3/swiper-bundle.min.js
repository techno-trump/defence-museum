!function(e, t) {
    ...
    var I = {
        ...
        updateSlides: function() {
            ...
            for (let i = 0; i < m; i += 1) {
                ...
                if (z = 0, p[i] && (r = p[i]), L && e.grid.updateSlide(i, r, m, t), !p[i] || "none" !== w(r, "display")) {
                    if ("auto" === a.slidesPerView) {
                        ...
                        a.roundLengths) z = e.isHorizontal() ? x(r, "width", !0) : x(r, "height", !0); else {
            ...
            L && e.grid.updateWrapperSize(z, h, t), !a.centeredSlides) {
                const t = [];
        ...
        updateActiveIndex: function(e) {
            ...
            Object.assign(t, {
                ...
                previousIndex: r,
                activeIndex: d
            }), t.initialized && $(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), 
    ...
    const Z = {
        ...
        events: {
            attachEvents: function() {
                ...
                e.onTouchStart = H.bind(e), e.onTouchMove = X.bind(e), e.onTouchEnd = Y.bind(e), 
                s.cssMode && (e.onScroll = q.bind(e)), e.onClick = R.bind(e), e.onLoad = _.bind(e), 
                V || (t.addEventListener("touchstart", F), V = !0), j(e, "on");
            },
